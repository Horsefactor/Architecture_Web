...
/* base.html.twig */
class __TwigTemplate_2db6f7d672063bbcb6bdfc7dbc7a6c009b53046f12c9ad482f945d9fefb583c6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">
            <a class=\"navbar-brand\" href=\"#\">FindAJob</a>
        ...
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">
            ...
            <div class=\"collapse navbar-collapse\" id=\"navbarColor01\">
                <ul class=\"navbar-nav mr-auto\">
                    ...
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"{{path('search_posts')}}\">Posts</a>
                    </li>
                    <li class=\"nav-item\">
                    ...
                    {% if not app.user %}
                        <li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"{{path('security_login')}}\">Log In</a>
                        </li>
                    {% else %}
                        <li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"{{path('security_logout')}}\">Log Out</a>
                        </li>
                    {% endif %}
