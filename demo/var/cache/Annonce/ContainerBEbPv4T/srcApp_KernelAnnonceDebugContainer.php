 ...
 */
class srcApp_KernelAnnonceDebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_KernelAnnonceDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelAnnonceDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelAnnonceDebugContainer',
